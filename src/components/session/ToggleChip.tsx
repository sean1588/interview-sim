...
export default function ToggleChip({
  ...
  return (
    <label className="inline-flex cursor-pointer items-center gap-2 rounded-[7px] border border-edge bg-chip px-3 py-[7px] font-sans text-[13px] text-ink-soft has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-cognac/40">
      <input
        type="checkbox"
        checked={checked}
